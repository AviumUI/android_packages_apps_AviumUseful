...
package org.avium.aviumuseful.service.delivery;
...
import org.avium.aviumuseful.service.url.ClipboardListener;
...
public class DeliveryService extends Service implements
    ...
    public void onContentChanged(String newContent) {
        ...
        if (currentDetectedExpressNumber != null) {
            ...
            if (floatingIconManager == null) {
                floatingIconManager = new FloatingIconManager(appContext, R.drawable.icon_box, this);
            }
